...
$users = query("SELECT * FROM users join divisi on users.divisi = divisi.id_divisi  order by id_user desc");
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <div class="mb-3">
                        <h1 class="h3 d-inline align-middle">Laporan</h1>
                        </a>
                    </div>
                    <div class="row">
                                    ...
                                    <table class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="detail-absensi.php?id=<?= $row['id_user']?>"
                                                        class="btn btn-success"><span><i class="align-middle"
                                                                data-feather="eye"></i></span></a>
                                                                <a href="detail-absensi-cetak.php?id=<?= $row['id_user']?>"
                                                        class="btn btn-success"><span><i class="align-middle"
